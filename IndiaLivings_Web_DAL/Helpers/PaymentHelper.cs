...
namespace IndiaLivings_Web_DAL.Helpers
{
    public class PaymentHelper
    {
        public int AddInvoice(InvoiceModel IM)
        {
            ...
            try
            {
                response = ServiceAPI.Post_Api("Invoices/addInvoice", IM).Trim('\"');
            }
            catch (Exception ex)
            {
        ...
        public int UpdateInvoice(InvoiceModel IM)
        {
            ...
            try
            {
                response = ServiceAPI.Post_Api("Invoices/updateInvoice", IM).Trim('\"');
            }
            catch (Exception ex)
            {
                ErrorLog.insertErrorLog(ex.Message, ex.StackTrace, ex.Source);
        ...
        public List<InvoiceModel> GetInvoiceByUser(int userid)
        {
            ...
            try
            {
                response = ServiceAPI.Get_async_Api("Invoices/GetInvoiceByUser?UserID=" + userid);
